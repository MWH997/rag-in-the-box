...
export function Logo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden className={cn("h-5 w-5 shrink-0", className)}>
      <path
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M13.6 5.4h6.9v5.2h-6.9z" fill="currentColor" opacity="0.16" />
      <path
